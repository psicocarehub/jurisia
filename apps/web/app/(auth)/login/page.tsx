      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-gradient-to-br from-legal-blue-950 via-legal-blue-900 to-legal-blue-800 p-12 text-white">
        ...
        <div className="space-y-8">
          <h2 className="text-3xl font-bold leading-tight">
            Sua assistente juridica<br />
            com inteligencia artificial
          </h2>
          <div className="space-y-4">
            <Feature text="Pesquisa inteligente em milhoes de decisoes" />
            <Feature text="Geracao de peticoes com verificacao de citacoes" />
            <Feature text="Jurimetria e analise de padroes de juizes" />
            <Feature text="Monitoramento de mudancas legislativas" />
          </div>
        </div>
      ...
      <div className="flex w-full items-center justify-center bg-gray-50 px-6 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <div>
              ...
              <input
                ...
                placeholder="identificador-do-escritorio"
                required
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            Nao tem conta?{' '}
            <Link href="/register" className="font-semibold text-legal-blue-600 hover:text-legal-blue-500">
  ...
  return (
    <div className="flex items-center gap-3">
      <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/10">
        <svg className="h-3.5 w-3.5 text-legal-blue-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
